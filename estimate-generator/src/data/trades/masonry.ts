...
export const masonry: Trade = {
  ...
  lineItems: [
    ...
    { description: 'Concrete block, supplied and laid', unit: 'each', defaultQty: 480, defaultRate: 6.5 },
    { description: 'Brick veneer, supplied and laid', unit: 'sq ft', defaultQty: 240, defaultRate: 22 },
